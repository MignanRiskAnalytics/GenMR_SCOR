...
2. *Implementation of additional perils & environmental layers* (v1.1.2, published in Jun. 2026): Development of climatic and socio-economic perils, which were not included in the 2024 CAT Risk Modelling Sandbox.
3. *Implementation of Multi-Risk Core* (v1.2.1, ONGOING, due Sep. 2026): Modelling of chains-of-events and risk drivers within the GenMR framework.
...
Tutorial 3: Dynamic risk modelling<notebooks/Tutorial3_DigitalTemplate_dynamics>
```
